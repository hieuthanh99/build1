<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ImportUnit.aspx.cs" Inherits="Imports_ImportUnit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <script src="../Scripts/jquery-1.11.1.min.js"></script>
    <script src="../Scripts/PageModuleBase.js"></script>
    <script src="../Scripts/ImportUnit.js"></script>
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    <td style="padding-left: 5px;">
                                                        <dx:ASPxComboBox ID="cboFileType" runat="server" DropDownStyle="DropDownList" ClientInstanceName="ClientFileType" Width="200px" ValueType="System.String" Caption="Tên mẫu" OnInit="cboFileType_Init">
                                                            <ClientSideEvents ValueChanged="RevCost.ClientFileType_ValueChanged" />
                                                        </dx:ASPxComboBox>
                                                    </td>
                                                    <td style="padding-left: 5px;">
                                                        <dx:ASPxComboBox ID="cboCompany" runat="server" DropDownStyle="DropDownList" ClientVisible="false" ClientInstanceName="ClientCompany" Width="200px" ValueType="System.String" Caption="Đơn vị" OnInit="cboCompany_Init">
                                                        </dx:ASPxComboBox>
                                                    </td>
                                                    <td style="padding-left: 5px;">
        ...
        <ContentCollection>
            <dx:PopupControlContentControl>
                <dx:ASPxGridView ID="VersionGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                    ...
                    <Settings ShowFilterRow="true" VerticalScrollBarMode="Visible" VerticalScrollableHeight="350" VerticalScrollBarStyle="Standard" />
                    <Paddings Padding="0px" />
                ...
                <dx:ASPxFormLayout ID="EditForm" ColCount="2" runat="server" RequiredMarkDisplayMode="Auto" Styles-LayoutGroupBox-Caption-CssClass="layoutGroupBoxCaption"
                    ...
                    <Items>
                        <dx:LayoutItem Caption="From Month">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxSpinEdit runat="server" ID="FromMonthEditor" MaxValue="12" MinValue="1" Width="100%" HorizontalAlign="Right" ClientInstanceName="ClientFromMonthEditor">
                        ...
                        <dx:LayoutItem Caption="To Month">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxSpinEdit runat="server" ID="ToMonthEditor" MaxValue="12" MinValue="1" Width="100%" HorizontalAlign="Right" ClientInstanceName="ClientToMonthEditor">
                                        <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ValidateOnLeave="true" SetFocusOnError="true" ErrorTextPosition="Right">
                                            <RequiredField IsRequired="True" />
                                        </ValidationSettings>
                                    </dx:ASPxSpinEdit>
