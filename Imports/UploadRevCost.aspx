<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="UploadRevCost.aspx.cs" Inherits="Imports_UploadRevCost" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <script src="../Scripts/jquery-1.11.1.min.js"></script>
    <script src="../Scripts/PageModuleBase.js"></script>
    <script src="../Scripts/UploadCost.js"></script>
    <dx:ASPxSplitter ID="contentSplitter" runat="server" ClientInstanceName="ClientContentSplitter" Orientation="Vertical" Width="100%" Height="100%" ResizingMode="Live" Theme="MaterialCompact">
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                   <%--  <td style="padding-left: 5px;">
                                                        <dx:ASPxComboBox ID="cboAreaCode" runat="server" DropDownStyle="DropDownList" ClientInstanceName="ClientAreaCodeLoad" Width="90px" ValueType="System.String" Caption="Area Code" OnInit="cboAreaCode_Init" Theme="MaterialCompact">
                                                            <ClientSideEvents ValueChanged="RevCost.ClientAreaCodeLoad_ValueChanged" />
                                                        </dx:ASPxComboBox>
                                                    </td>--%>
                                                    <td style="padding-left: 5px;">
                                                        <dx:ASPxComboBox ID="cboFileType" runat="server" DropDownStyle="DropDownList" ClientInstanceName="ClientFileType" Width="230px" ValueType="System.String" Caption="File Type" OnInit="cboFileType_Init" Theme="MaterialCompact">
                                                            <ClientSideEvents ValueChanged="RevCost.ClientFileType_ValueChanged" />
                                                        </dx:ASPxComboBox>
                                                    </td>
                                                    <td style="padding-left: 5px;">
                                                        <dx:ASPxButton ID="btnDownloadTemplate" runat="server" Text="Template" AutoPostBack="false" Theme="MaterialCompact">
                                                    ...
                                                    <td style="padding-left: 5px;">
                                                        <dx:ASPxUploadControl ID="UploadControl" runat="server" ClientInstanceName="ClientUploadControl" ShowProgressPanel="true" NullText="Browse file here"
                                                            Width="280px" FileUploadMode="OnPageLoad" UploadMode="Advanced" OnFilesUploadComplete="UploadControl_FilesUploadComplete" BrowseButton-Text="Duyệt file" Theme ="MaterialCompact">
                                                    ...
                                                    <td style="padding-left: 5px;">
                                                        <dx:ASPxButton ID="btnUploadFile" runat="server" Text="Upload File" AutoPostBack="false" Theme="Material">
                                                    ...
                                                    <td style="padding-left: 5px;">
                                                        <dx:ASPxButton ID="btnRefresh" runat="server" Text="Refresh" AutoPostBack="false" Theme="Material">
                                                            <%--<ClientSideEvents Click="RevCost.ClientFilesUploadButton_Click" />--%>
                                                        </dx:ASPxButton> 
                                                    </td>
                                                    <td tyle="padding-left: 5px;">
                                                         <dx:ASPxComboBox  ID="cboToMonth" runat="server" Width="60px" OnInit="cboToMonth_Init" Caption="From Month" ClientInstanceName="ClientcboToMonth" Theme="MaterialCompact"></dx:ASPxComboBox>
                                                    </td>
                                                    <td tyle="padding-left: 5px;">
                                                        <dx:ASPxComboBox  ID="cboFromMonth" runat="server" Width="60px" OnInit="cboFromMonth_Init" Caption="To Month" ClientInstanceName="ClientcboFromMonth" Theme="MaterialCompact"></dx:ASPxComboBox>
                                                    </td>
                                                    <td  style="padding-left: 5px;">
                                                        <dx:ASPxButton ID="btnShowVersion" runat="server" ClientInstanceName="ClientShowVersionButton" Text="Apply To Version" UseSubmitBehavior="true" AutoPostBack="false" Theme="MaterialCompact">
                                                            <ClientSideEvents Click="RevCost.ClientShowVersionButton_Click" />
                                                        </dx:ASPxButton>
                                                    </td>
                                                    <%--<td style="padding-left: 5px;">
                                                        <dx:ASPxComboBox  ID="cboToMonth" runat="server" Width="60px" OnInit="cboToMonth_Init" Caption="From Month" ClientInstanceName="ClientcboToMonth"></dx:ASPxComboBox>
                                                         
                                                    </td>--%>
                                                    <%--<td style="padding-left: 5px;">
                                                         <dx:ASPxComboBox  ID="cboFromMonth" runat="server" Width="60px" OnInit="cboFromMonth_Init" Caption="To Month" ClientInstanceName="ClientcboFromMonth"></dx:ASPxComboBox>
                                                    </td>--%>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <ContentCollection>
                                    <dx:SplitterContentControl>
                                        <dx:ASPxGridView ID="FileHistoryGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                                            ...
                                            OnCustomCallback="FileHistoryGrid_CustomCallback" Theme="MaterialCompact">
                                            <Columns>
                                                <dx:GridViewDataTextColumn FieldName="HistoryID" VisibleIndex="1" Caption="ID" Width="80" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="FileName" VisibleIndex="4" Caption="File Name" Width="350" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                </dx:GridViewDataTextColumn>
                ...
                <ContentCollection>
                    <dx:SplitterContentControl>
                        <dx:ASPxGridView ID="DataHistoryGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                            ...
                            OnCustomCallback="DataHistoryGrid_CustomCallback" Theme="MaterialCompact">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="ATT3" VisibleIndex="4" Caption="Col 4" Width="250" Visible="false" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
    ...
    <dx:ASPxPopupControl ID="PopupSelectExcelSheet" runat="server" ClientInstanceName="ClientPopupSelectExcelSheet"
        ...
        HeaderText="Select Sheet" ShowCloseButton="False" Theme="MaterialCompact">
        <ContentCollection>
            <dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server">
                <dx:ASPxListBox ID="SheetListBox" runat="server" ClientInstanceName="ClientSheetListBox" Width="100%" ValueType="System.String" SelectionMode="Single" OnCallback="SheetListBox_Callback" Theme="MaterialCompact">
        ...
        <FooterTemplate>
            <dx:ASPxButton CssClass="AddressBookPopupButton" ID="btnCancel" runat="server" Text="Close" AutoPostBack="false" Theme="MaterialCompact">
                <ClientSideEvents Click="function(s, e) {{ ClientPopupSelectExcelSheet.Hide();}}" />
            </dx:ASPxButton>
            <dx:ASPxButton CssClass="AddressBookPopupButton" ID="btnUpload" runat="server" Text="Upload Data" AutoPostBack="false" ClientInstanceName="ClientUploadDataButton" UseSubmitBehavior="true" Theme="MaterialCompact">
    ...
    <dx:ASPxPopupControl ID="PopupProgressingPanel" runat="server" ClientInstanceName="PopupProgressingPanel"
        ...
        PopupVerticalAlign="WindowCenter" AllowDragging="True" PopupAnimationType="None"
        HeaderText="Uploading Info" ShowCloseButton="False" ShowPageScrollbarWhenModal="true" Theme="MaterialCompact">
        <ContentCollection>
    ...
    <dx:ASPxPopupControl ID="ApplyVersionPopup" runat="server" Width="700" Height="400" AllowDragging="True" HeaderText="Apply To Version" ShowFooter="True"
        Modal="true" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" AllowResize="false"
        PopupAnimationType="Fade" ClientInstanceName="ClientApplyVersionPopup" ShowCloseButton="true" CloseAction="CloseButton" Theme="MaterialCompact">
        <ContentCollection>
            <dx:PopupControlContentControl>
                ...
                <dx:ASPxGridView ID="VersionGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                    ...
                    OnCustomCallback="VersionGrid_CustomCallback" Theme="MaterialCompact">
                    <Columns>
        ...
        <FooterTemplate>
            ...
            <%-- <dx:ASPxComboBox CssClass="AddressBookPopupButton" ID="cboToMonth" runat="server" Width="120px" OnInit="cboToMonth_Init" ClientInstanceName="ClientcboToMonth"></dx:ASPxComboBox>
            <dx:ASPxComboBox  CssClass="AddressBookPopupButton" ID="cboFromMonth" runat="server" Width="120px" OnInit="cboFromMonth_Init" ClientInstanceName="ClientcboFromMonth"></dx:ASPxComboBox>--%>
            <div class="clear"></div>
        </FooterTemplate>
    ...
    <dx:ASPxPopupControl ID="ParamsPopup" runat="server" Width="500" Height="100" AllowDragging="True" HeaderText="Download Template" ShowFooter="True"
        Modal="true" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" AllowResize="false"
        PopupAnimationType="Fade" ClientInstanceName="ClientParamsPopup" ShowCloseButton="true" CloseAction="CloseButton" Theme="MaterialCompact">
        <ContentCollection>
            <dx:PopupControlContentControl>
                <dx:ASPxFormLayout ID="ParamsForm" runat="server" ColCount="1" RequiredMarkDisplayMode="Auto" Styles-LayoutGroupBox-Caption-CssClass="layoutGroupBoxCaption"
                    AlignItemCaptionsInAllGroups="true" Width="100%" OptionalMark="" Theme="MaterialCompact">
                    <Items>

                        <dx:LayoutItem Caption="Area Code:">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="cboArea1" runat="server" ClientInstanceName="ClientAreaCode" Width="120px" OnInit="cboArea1_Init" Theme="MaterialCompact">
                        ...
                        <dx:LayoutItem Caption="Data Version">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="cboVersion" runat="server" ClientInstanceName="ClientVersion" Width="180px" OnInit="cboVersion_Init" Theme="MaterialCompact">
                                        <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ValidateOnLeave="true" SetFocusOnError="true" ErrorTextPosition="Right">
                                            <RequiredField IsRequired="True" />
                                        </ValidationSettings>
                                    </dx:ASPxComboBox>
                        ...
                        <dx:LayoutItem Caption="Plan Version">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="cboPlanVersion" runat="server" ClientInstanceName="ClientPlanVersion" Width="180px" OnInit="cboPlanVersion_Init" Theme="MaterialCompact">
                                        <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ValidateOnLeave="true" SetFocusOnError="true" ErrorTextPosition="Right">
                                            <RequiredField IsRequired="True" />
                                        </ValidationSettings>
                                    </dx:ASPxComboBox>
                        ...
                        <dx:LayoutItem Caption="Plan From Month">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="cboPlanMonth" runat="server" ClientInstanceName="ClientPlanMonth" Width="120px" OnInit="cboPlanMonth_Init" Theme="MaterialCompact">
                                        <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ValidateOnLeave="true" SetFocusOnError="true" ErrorTextPosition="Right">
                                            <RequiredField IsRequired="True" />
                                        </ValidationSettings>
                                    </dx:ASPxComboBox>
