<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ImportUnitStore.aspx.cs" Inherits="Imports_ImportUnit" %>
                                ...
                                <ContentCollection>
                                    <dx:SplitterContentControl>
                                          <div style="float: right;">
                                            <div class="title">
                                                <asp:Literal ID="Literal1" runat="server" Text="IMPORT QUANTITY" />
                                            </div>
                                        </div>
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 5px;">
                                                        ...
                                                        <dx:ASPxButton ID="btnApplyToVersion" runat="server" Text="Apply To Version" AutoPostBack="false"></dx:ASPxButton>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                    ...
                    <dx:SplitterContentControl>
                        <dx:ASPxGridView ID="DataHistoryGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="ATT1" VisibleIndex="2" Caption="Col 2" Visible="false" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataTextColumn FieldName="ATT3" VisibleIndex="4" Caption="Col 4" Visible="false" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
                            ...
                            <Templates>
                                <TitlePanel>
                                    <div style="float: left">
                                        <dx:ASPxLabel runat="server" Font-Bold="true" Text="Data history"></dx:ASPxLabel>
                                    </div>
                                </TitlePanel>
                            </Templates>
                        </dx:ASPxGridView>
