<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AircraftPilotCrew.aspx.cs" Inherits="Configs_AircraftPilotCrew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Callback_CallbackComplete(s, e) {
            ClientDataGrid.batchEditApi.SetCellValue(currentRowIndex, "Year", e.result);
        }
                ...
                <ContentCollection>
                    <dx:SplitterContentControl>
                        <div style="float: left">
                            <div class="title">
                                <asp:Literal ID="Literal1" runat="server" Text="Pilot & Crew" />
                            </div>
                        </div>
                    ...
                    <dx:SplitterContentControl>
                        <dx:ASPxGridView ID="DataGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true" OnCustomCallback="DataGrid_CustomCallback" OnCustomDataCallback="DataGrid_CustomDataCallback"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataSpinEditColumn FieldName="Year" VisibleIndex="2" Caption="Year" ReadOnly="true" Width="100" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                    <PropertiesSpinEdit>
                                ...
                                <dx:GridViewDataComboBoxColumn FieldName="PilotCrew" VisibleIndex="3" Caption="PilotCrew" Width="100" CellStyle-HorizontalAlign="Left">
                                    <PropertiesComboBox
                                        ValueType="System.String" DropDownStyle="DropDownList">
                                        <ClearButton DisplayMode="OnHover" />
                                        <Items>
                                            <dx:ListEditItem Value="PILOT" Text="PILOT" />
                                            <dx:ListEditItem Value="CREW" Text="CREW" />
                                        </Items>
                                    </PropertiesComboBox>
                                </dx:GridViewDataComboBoxColumn>
                                <dx:GridViewDataComboBoxColumn FieldName="ACGroup" VisibleIndex="3" Caption="ACGroup" Width="100" CellStyle-HorizontalAlign="Left">
                                    <PropertiesComboBox
                                        ValueType="System.String" DropDownStyle="DropDownList">
                                        <ClearButton DisplayMode="OnHover" />
                                        <Items>
                                            <dx:ListEditItem Value="B787" Text="B787" />
                                            <dx:ListEditItem Value="AIRBUS" Text="AIRBUS" />
                                            <dx:ListEditItem Value="E190" Text="E190" />
                                        </Items>
                                    </PropertiesComboBox>
                                </dx:GridViewDataComboBoxColumn>
