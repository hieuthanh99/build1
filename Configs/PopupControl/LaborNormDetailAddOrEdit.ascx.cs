...
public partial class Configs_PopupControl_LaborNormDetailAddOrEdit : System.Web.UI.UserControl
{
    ...
    protected void GroupEditor_Init(object sender, EventArgs e)
    {
        ...
        var list = entities.DecTableValues
                            .Where(x => x.Tables == "ITEMMASTER" && x.Field == "GROUPITEM" && x.DefValue != "TTBTX" && x.DefValue != "TTBKTX")
                            .Select(x => new
                            {
                                DefValue = x.DefValue,
    ...
    protected void CodeEditor_Callback(object sender, CallbackEventArgsBase e)
    {
        ASPxComboBox cbo = sender as ASPxComboBox;
