<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PositionStationeryLOV.ascx.cs" Inherits="Configs_PopupControl_PositionStationeryLOV" %>

<dx:ASPxGridView ID="LOVPositionStationeryGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
    ClientInstanceName="ClientLOVPositionStationeryGrid" Width="100%" KeyFieldName="StationeryID" >
    <Columns>
