...
public partial class Configs_AOGTime : BasePage
{
    ...
    {
        var list = entities.AOGTimes.ToList();
    ...
    protected void DataGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
    {
        ...
        if (args[0] == "DELETE")
        {
            ...
            var entity = entities.AOGTimes.SingleOrDefault(x => x.Id == key);
            if (entity != null)
            {
                entities.AOGTimes.Remove(entity);
