<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="KTQTAircraft.aspx.cs" Inherits="Pages_KTQTAircraft" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ShowEditForm(command, key) {
            ...
            ClientAircraftIataEditor.SetValue("");
            ClientAircraftVNEditor.SetValue("");
            ClientAircraftNameEditor.SetValue("");
            ClientMTOWMinEditor.SetValue(0);
            ClientMTOWMaxEditor.SetValue(0);
            ClientCarrierEditor.SetValue("");
            ClientPaxMinEditor.SetValue(0);
            ClientPaxMaxEditor.SetValue(0);
            ...
            if (command == "NEW") {
                ...
                ClientDataGrid.GetValuesOnCustomCallback("EditForm|" + command + "|" + key, function (values) {
                    var setValuesFunc = function () {
                        ...
                        ClientACIDEditor.SetValue(values["Aircraft"]);
                        ClientAircraftIataEditor.SetValue(values["Aircraft_Iata"]);
                        ClientAircraftVNEditor.SetValue(values["Aircraft_VN"]);
                        ClientAircraftNameEditor.SetValue(values["AircraftName"]);
                        ClientMTOWMinEditor.SetValue(values["MTOW_Min"]);
                        ClientMTOWMaxEditor.SetValue(values["MTOW_Max"]);
                        ClientCarrierEditor.SetValue(values["Carrier"]);
                        ClientPaxMinEditor.SetValue(values["Pax_Min"]);
                        ClientPaxMaxEditor.SetValue(values["Pax_Max"]);
        ...
        function ClientSyncVMSButton_Click(s, e) {
            var cf = confirm("Confirm Sync DM Aircraft?");
            if (cf) {
                DoCallback(ClientDataGrid, function () {
                    ClientDataGrid.PerformCallback('SyncVMS');
                });
            }
        }
                        ...
                        <div style="float: left">
                            ...
                            <dx:ASPxMenu ID="mMain" runat="server" CssClass="main-menu" Theme="Moderno" OnItemClick="mMain_ItemClick">
                                ...
                                <Items>
                                    ...
                                    <dx:MenuItem Name="EXPORT" Text="Export" ItemStyle-CssClass="menu-item" Image-Url="../Content/images/action/export.png" Image-Height="16px" Image-Width="16px">
                                        <Items>
                ...
                <ContentCollection>
                    <dx:SplitterContentControl>
                        <dx:ASPxGridView ID="DataGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true" OnCustomCallback="DataGrid_CustomCallback" OnCustomDataCallback="DataGrid_CustomDataCallback"
                            ClientInstanceName="ClientDataGrid" Width="100%" KeyFieldName="AircraftID">
                            <Columns>
                                <dx:GridViewDataTextColumn FieldName="AircraftID" VisibleIndex="1" Caption="ID" Width="50" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="Aircraft" VisibleIndex="1" Caption="Aircraft" Width="80" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="Aircraft_Iata" VisibleIndex="1" Caption="Aircraft Iata" Width="80" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="Aircraft_VN" VisibleIndex="1" Caption="Aircraft VN" Width="200" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="AircraftName" VisibleIndex="1" Caption="Aircraft Name" Width="300" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="MTOW_Min" VisibleIndex="1" Caption="MTOW Min" Width="80" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="MTOW_Max" VisibleIndex="1" Caption="MTOW Max" Width="80" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="Carrier" VisibleIndex="1" Caption="Carry" Width="50" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="Pax_Min" VisibleIndex="1" Caption="Pax Min" Width="80" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="Pax_Max" VisibleIndex="1" Caption="Pax Max" Width="80" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
                            ...
                            <Settings ShowFilterRow="true" ShowStatusBar="Hidden" VerticalScrollBarMode="Visible" VerticalScrollableHeight="500" VerticalScrollBarStyle="Standard" HorizontalScrollBarMode="Auto" />
                           ...
                           <%-- <Templates>
                                <StatusBar>
                                    <dx:ASPxButton ID="btnUpdateVMS" runat="server" Text="Sync from VMS" AutoPostBack="false" Font-Bold="true">
                                        <ClientSideEvents Click="ClientSyncVMSButton_Click" />
                                    </dx:ASPxButton>
                                </StatusBar>
                            </Templates>--%>
            ...
            <dx:PopupControlContentControl>
                <dx:ASPxFormLayout ID="EditForm" runat="server" ColCount="2" RequiredMarkDisplayMode="Auto" Styles-LayoutGroupBox-Caption-CssClass="layoutGroupBoxCaption" ClientInstanceName="ClientEditForm"
                    ...
                    <Items>
                        ...
                        <dx:LayoutItem Caption="Aircraft Iata">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox runat="server" ID="AircraftIataEditor" Width="170" ClientInstanceName="ClientAircraftIataEditor">
                                        <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ValidateOnLeave="true" SetFocusOnError="true">
                                            <RequiredField IsRequired="True" />
                                        </ValidationSettings>
                                    </dx:ASPxTextBox>
                        ...
                        <dx:LayoutItem Caption="Aircraft VN">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox runat="server" ID="AircraftVNEditor" Width="170" ClientInstanceName="ClientAircraftVNEditor">
                                    </dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem Caption="Aircraft Name">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox runat="server" ID="AircraftNameEditor" Width="170" ClientInstanceName="ClientAircraftNameEditor">
                                        <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ValidateOnLeave="true" SetFocusOnError="true">
                                            <RequiredField IsRequired="True" />
                                        </ValidationSettings>
                                    </dx:ASPxTextBox>
                        ...
                        <dx:LayoutItem Caption="MTOW Min">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxSpinEdit runat="server" ID="MTOWMinEditor" Width="170" ClientInstanceName="ClientMTOWMinEditor" DisplayFormatString="N0">
                                    </dx:ASPxSpinEdit>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem Caption="MTOW Max">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxSpinEdit runat="server" ID="MTOWMaxEditor" Width="170" ClientInstanceName="ClientMTOWMaxEditor" DisplayFormatString="N0">
                                    </dx:ASPxSpinEdit>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem Caption="Carrier">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox runat="server" ID="CarrierEditor" Width="170" ClientInstanceName="ClientCarrierEditor">
                                    </dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem Caption="Pax Min">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxSpinEdit runat="server" ID="PaxMinEditor" Width="170" ClientInstanceName="ClientPaxMinEditor" DisplayFormatString="N0">
                                    </dx:ASPxSpinEdit>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem Caption="Pax Max">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxSpinEdit runat="server" ID="PaxMaxEditor" Width="170" ClientInstanceName="ClientPaxMaxEditor" DisplayFormatString="N0">
                                    </dx:ASPxSpinEdit>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        ...
                        <dx:LayoutItem Caption="Note" ColSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxMemo runat="server" ID="NoteEditor" Width="480" Rows="3" ClientInstanceName="ClientNoteEditor">
                                    </dx:ASPxMemo>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
