<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Companies.aspx.cs" Inherits="Pages_Companies" %>
                    ...
                    <dx:SplitterContentControl>
                        <dx:ASPxTreeList ID="DataGrid" runat="server" Width="100%" ClientInstanceName="ClientDataGrid" KeyFieldName="CompanyID" ParentFieldName="ParentID"
                            ...
                            <Columns>
                                ...
                                <dx:TreeListTextColumn FieldName="AreaCode" VisibleIndex="4" Caption="Area" Width="80"></dx:TreeListTextColumn>
                                <dx:TreeListDateTimeColumn FieldName="ValidFrom" VisibleIndex="5" Caption="Valid From">
                                    <PropertiesDateEdit EditFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                                </dx:TreeListDateTimeColumn>
                                <dx:TreeListDateTimeColumn FieldName="ValidTo" VisibleIndex="6" Caption="Valid To">
                                    <PropertiesDateEdit EditFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                                </dx:TreeListDateTimeColumn>
                                <dx:TreeListTextColumn FieldName="Note" VisibleIndex="7" Caption="Note" Width="300"></dx:TreeListTextColumn>
                ...
                <dx:ASPxFormLayout ID="EditForm" runat="server" RequiredMarkDisplayMode="Auto" Styles-LayoutGroupBox-Caption-CssClass="layoutGroupBoxCaption" ClientInstanceName="ClientEditForm"
                    ...
                    <Items>
                        ...
                        <%--<dx:LayoutItem Caption="Division">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox runat="server" ID="DivisionEditor" Width="250" ValueType="System.Int32" ClientInstanceName="ClientDivisionEditor" OnInit="DivisionEditor_Init">
                                    </dx:ASPxComboBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>--%>
                        <dx:LayoutItem Caption="Short Name">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox runat="server" ID="ShortNameEditor" Width="250" ClientInstanceName="ClientShortNameEditor" OnValidation="ShortNameEditor_Validation">
                        ...
                        <dx:LayoutItem Caption="Group">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox runat="server" ID="CompanyGroupEditor" Width="250" ValueType="System.String" ClientInstanceName="ClientCompanyGroupEditor">
                                        <Items>
                                            <dx:ListEditItem Value="CPSX" Text="Chi phí sản xuất" />
                                            <dx:ListEditItem Value="CPQL" Text="Chi phí quản lý" />
                                            <dx:ListEditItem Value="CPTT" Text="Chi phí trực tiếp" />
                                        </Items>
                                    </dx:ASPxComboBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        ...
                        <dx:LayoutItem Caption="Type">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox runat="server" ID="CompanyTypeEditor" Width="250" ValueType="System.String" ClientInstanceName="ClientCompanyTypeEditor">
                                        <Items>
