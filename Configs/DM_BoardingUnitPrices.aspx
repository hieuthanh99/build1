<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DM_BoardingUnitPrices.aspx.cs" Inherits="Configs_DM_BoardingUnitPrices" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <script src="../Scripts/BoardingUnitPrices.js"></script>
                ...
                <ContentCollection>
                    <dx:SplitterContentControl>
                        ...
                        <div style="float: left">
                            <div class="title">
                                <asp:Literal ID="Literal1" runat="server" Text="ĐƠN GIÁ THUÊ QUẦY BOARDING" />
                            </div>
                        </div>
                    </dx:SplitterContentControl>
                </ContentCollection>
                        ...
                        <ContentCollection>
                            <dx:SplitterContentControl>
                                <dx:ASPxGridView ID="UnitPriceGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                                    ClientInstanceName="ClientUnitPriceGrid" Width="100%" KeyFieldName="BoardingUnitPriceID"
