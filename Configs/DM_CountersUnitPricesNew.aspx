<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DM_CountersUnitPricesNew.aspx.cs" Inherits="Configs_DM_CountersUnitPricesNew" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <script src="../Scripts/PageModuleBase.js"></script>
    <script src="../Scripts/CountersUnitPricesNew.js"></script>
    <style>
        ...
        <Panes>
            ...
            <dx:SplitterPane Separator-Visible="false">
                <Panes>
                                    ...
                                    <dx:SplitterContentControl>
                                        <dx:ASPxGridView ID="MasterGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataColumn FieldName="Description" VisibleIndex="12" Caption="Diễn giải" Width="500" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                    <CellStyle Wrap="True"></CellStyle>
                                            ...
                                            <Templates>
                                                <StatusBar>
                                                    <div style="float: right">
                                                        <dx:ASPxButton runat="server" Text="LƯU THAY ĐỔI" RenderMode="Button" AutoPostBack="false" Font-Bold="true" UseSubmitBehavior="true" Image-Width="16">
                                                            <ClientSideEvents Click="RevCost.ClientSaveDataGridButton_Click" />
                                                            <Image Url="../../Content/images/action/save.png" Height="16"></Image>
                                                        </dx:ASPxButton>
                                                        &nbsp;
                                                        <dx:ASPxButton runat="server" Text="HỦY THAY ĐỔI" RenderMode="Button" AutoPostBack="false" Font-Bold="true" UseSubmitBehavior="true" Image-Width="16">
                    ...
                    <dx:SplitterPane>
                        <Panes>
                            <dx:SplitterPane Name="CountersCostPane" Size="460">
                                <ContentCollection>
                                    <dx:SplitterContentControl>
                                        &nbsp;<dx:ASPxComboBox ID="cboQuantityVersion" runat="server" ValueType="System.Int32" Width="350px" ClientInstanceName="ClientQuantityVersion" Font-Bold="true" Caption=" Version sản lượng" OnCallback="cboVersion_Callback">
                                        ...
                                        &nbsp;
                                        <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" Width="100%" Height="100%" ActiveTabIndex="0">
                                            <Paddings Padding="0" />
                                            <ActiveTabStyle Font-Bold="true"></ActiveTabStyle>
                                            <TabPages>
                                                <dx:TabPage Text="DANH SÁCH ĐƠN GIÁ THUÊ QUẦY">
                                                    <ContentCollection>
                                                        <dx:ContentControl>
                                                            <%-- &nbsp;
                                                            <dx:ASPxComboBox ID="cboQuantityVersion" runat="server" ValueType="System.Int32" Width="350px" ClientInstanceName="ClientQuantityVersion" Font-Bold="true" Caption="Version sản lượng" OnCallback="cboVersion_Callback">
                                                            ...
                                                            &nbsp;--%>
                                                            <dx:ASPxGridView ID="CountersCostGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                                                                ClientInstanceName="ClientCountersCostGrid" Width="100%" KeyFieldName="CounterCostID"
                                                                OnCustomCallback="CountersCostGrid_CustomCallback"
                                                                OnBatchUpdate="CountersCostGrid_BatchUpdate">
                                                                <Columns>
                                                                    <dx:GridViewDataSpinEditColumn FieldName="ForMonth" VisibleIndex="1" Caption="Tháng" Width="60" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                        <CellStyle Wrap="True"></CellStyle>
                                                                        <EditFormSettings Visible="False" />
                                                                    </dx:GridViewDataSpinEditColumn>
                                                                    <%--   <dx:GridViewDataComboBoxColumn FieldName="RentalType" VisibleIndex="2" Caption="Loại thuê quầy" Width="120" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                        <CellStyle Wrap="True"></CellStyle>
                                                                        <PropertiesComboBox>
                                                                            <Items>
                                                                                <dx:ListEditItem Value="CHUYEN" Text="Chuyến bay" />
                                                                    ...
                                                                    <dx:GridViewDataSpinEditColumn FieldName="Amount" VisibleIndex="3" Caption="Đơn giá" Width="120" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                        <CellStyle Wrap="True"></CellStyle>
                                                                        <PropertiesSpinEdit DisplayFormatString="N2">
                                                                            <ValidationSettings ValidateOnLeave="true" ErrorDisplayMode="None">
                                                                                <RequiredField IsRequired="true" ErrorText="*" />
                                                                    ...
                                                                    <dx:GridViewDataComboBoxColumn FieldName="CurrencyCode" VisibleIndex="4" Caption="Loại tiền" Width="60" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                        <CellStyle Wrap="True"></CellStyle>
                                                                        <PropertiesComboBox>
                                                                            <Items>
                                                                                <dx:ListEditItem Value="VND" Text="VND" />
                                                                    ...
                                                                    <dx:GridViewDataSpinEditColumn FieldName="Quantity" VisibleIndex="5" Caption="Số lượng" Width="80" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                        <CellStyle Wrap="True"></CellStyle>
                                                                        <PropertiesSpinEdit DisplayFormatString="N0">
                                                                            <ValidationSettings ValidateOnLeave="true" ErrorDisplayMode="None">
                                                                                <RequiredField IsRequired="true" ErrorText="*" />
                                                                    ...
                                                                    <dx:GridViewDataTextColumn FieldName="UnitOfMeasure" VisibleIndex="6" Caption="ĐVT" Width="70" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                        <CellStyle Wrap="True"></CellStyle>
                                                                        <PropertiesTextEdit>
                                                                            <ValidationSettings ValidateOnLeave="true" ErrorDisplayMode="None">
                                                                                <RequiredField IsRequired="true" ErrorText="*" />
                                                                    ...
                                                                    <dx:GridViewDataSpinEditColumn FieldName="DiscountPercent" VisibleIndex="7" Caption="Giảm giá/CK (%)" Width="100" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                        <CellStyle Wrap="True"></CellStyle>
                                                                        <PropertiesSpinEdit DisplayFormatString="{0:N2} %">
                                                                        </PropertiesSpinEdit>
                                                                    </dx:GridViewDataSpinEditColumn>
                                                                    <dx:GridViewDataColumn FieldName="Remark" VisibleIndex="8" Caption="Diễn giải" Width="800" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                        <CellStyle Wrap="True"></CellStyle>
                                                                    </dx:GridViewDataColumn>
                                                                </Columns>
                                                                <Styles>
                                                                ...
                                                                <Paddings PaddingTop="5px" PaddingLeft="0px" PaddingBottom="0px" PaddingRight="0px" />
                                                                <Border BorderWidth="1px" />
                                                                <BorderBottom BorderWidth="0px" />
                                                                <SettingsResizing ColumnResizeMode="Control" />
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSort="false" />
                                                                ...
                                                                <Templates>
                                                                    <StatusBar>
                                                                        <dx:ASPxButton runat="server" Text="PHÂN BỔ ĐƠN GIÁ THEO THÁNG CHO CHUYẾN BAY" Font-Bold="true" RenderMode="Button" AutoPostBack="false" UseSubmitBehavior="true" Image-Width="16">
                                                                            <ClientSideEvents Click="RevCost.ClientCalculateUnitPriceButton_Click" />
                                                                            <Image Url="../Content/images/configs.png" Height="16"></Image>
                                                                        </dx:ASPxButton>
                                                                    </StatusBar>
                                                                </Templates>
                                                                <ClientSideEvents EndCallback="RevCost.ClientCountersCostGrid_EndCallback" />
                                                            </dx:ASPxGridView>
                                                        </dx:ContentControl>
                                                    </ContentCollection>
                                                </dx:TabPage>
                                                <dx:TabPage Text="DANH SÁCH CÁC HÃNG SỬ DỤNG QUẦY">
                                                    <ContentCollection>
                                                        <dx:ContentControl>
                                                            <dx:ASPxSplitter ID="ASPxSplitter1" runat="server" Height="100%" Width="100%">
                                                                ...
                                                                <Panes>
                                                                        ...
                                                                        <ContentCollection>
                                                                            <dx:SplitterContentControl>
                                                                                <dx:ASPxGridView ID="CarrierGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                                                                                    ...
                                                                                    OnRowValidating="CarrierGrid_RowValidating">
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn FieldName="Carrier" VisibleIndex="3" Caption="Hãng" Width="70" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                                            <CellStyle Wrap="True"></CellStyle>
                                                                                            <PropertiesTextEdit>
                                                                                                <ValidationSettings ValidateOnLeave="true" ErrorDisplayMode="None">
                                                                                                    <RequiredField IsRequired="true" ErrorText="*" />
                                                                                        ...
                                                                                        <%--  <dx:GridViewDataSpinEditColumn FieldName="UsageRate" VisibleIndex="4" Caption="Tỷ lệ sử dụng quầy(%)" Width="120" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                                            <PropertiesSpinEdit DisplayFormatString="{0:N2} %">
                                                                                                <ValidationSettings ValidateOnLeave="true" ErrorDisplayMode="None">
                                                                                                    <RequiredField IsRequired="true" ErrorText="*" />
                                                                                                </ValidationSettings>
                                                                                        ...
                                                                                        <dx:GridViewDataColumn FieldName="Description" VisibleIndex="5" Caption="Diễn giải" Width="800" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                                            <CellStyle Wrap="True"></CellStyle>
                                                                                        </dx:GridViewDataColumn>
                                                                                    </Columns>
                                                                                    <Styles>
                                                                    ...
                                                                    <dx:SplitterPane Name="CarrierUsageRatePane" Size="450">
                                                                        <ContentCollection>
                                                                            <dx:SplitterContentControl>
                                                                                <dx:ASPxGridView ID="CarrierUsageRateGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                                                                                    ClientInstanceName="ClientCarrierUsageRateGrid" Width="100%" KeyFieldName="CarrierCounterUsageID"
                                                                                    OnCustomCallback="CarrierUsageRateGrid_CustomCallback"
                                                                                    OnBatchUpdate="CarrierUsageRateGrid_BatchUpdate">
                                                                                    <Columns>
                                                                                        <dx:GridViewDataSpinEditColumn FieldName="ForMonth" VisibleIndex="1" Caption="Tháng" Width="60" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                                            <CellStyle Wrap="True"></CellStyle>
                                                                                            <EditFormSettings Visible="False" />
                                                                                        ...
                                                                                        <dx:GridViewDataSpinEditColumn FieldName="UsageRate" VisibleIndex="7" Caption="Tỷ lệ sử dụng quầy (%)" Width="150" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                                                            <CellStyle Wrap="True"></CellStyle>
                                                                                            <PropertiesSpinEdit DisplayFormatString="{0:N2} %">
                                                                                                <ValidationSettings ValidateOnLeave="true" ErrorDisplayMode="None">
                                                                                                    <RequiredField IsRequired="true" ErrorText="*" />
                                                                                    ...
                                                                                    <Settings GroupFormat="{1}" ShowGroupPanel="false" ShowFilterRow="false" ShowStatusBar="Hidden" VerticalScrollBarMode="Visible" VerticalScrollableHeight="500" VerticalScrollBarStyle="Standard" HorizontalScrollBarMode="Auto" />
                                                                                    <Paddings PaddingTop="5px" PaddingLeft="0px" PaddingBottom="0px" PaddingRight="0px" />
                                                                                    <Border BorderWidth="1px" />
                                                                                    <BorderBottom BorderWidth="0px" />
                                                                                    <SettingsResizing ColumnResizeMode="Control" />
                                ...
                                <%-- <Panes>
                                    <dx:SplitterPane Name="CountersCostPane">
                                        <ContentCollection>
                                            <dx:SplitterContentControl>
                                                <dx:ASPxGridView ID="CountersCostGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                                                    ClientInstanceName="ClientCountersCostGrid" Width="100%" KeyFieldName="CounterCostID"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="Quantity" VisibleIndex="3" Caption="Số lượng" Width="80" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                            <CellStyle Wrap="True"></CellStyle>
                                                            <PropertiesSpinEdit DisplayFormatString="N0">
                                                                <ValidationSettings ValidateOnLeave="true" ErrorDisplayMode="None">
                                                                    <RequiredField IsRequired="true" ErrorText="*" />
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="UnitOfMeasure" VisibleIndex="4" Caption="ĐVT" Width="70" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                            <CellStyle Wrap="True"></CellStyle>
                                                            <PropertiesTextEdit>
                                                                <ValidationSettings ValidateOnLeave="true" ErrorDisplayMode="None">
                                                                    <RequiredField IsRequired="true" ErrorText="*" />
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="Amount" VisibleIndex="5" Caption="Đơn giá" Width="120" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                            <CellStyle Wrap="True"></CellStyle>
                                                            <PropertiesSpinEdit DisplayFormatString="N2">
                                                                <ValidationSettings ValidateOnLeave="true" ErrorDisplayMode="None">
                                                                    <RequiredField IsRequired="true" ErrorText="*" />
                                                        ...
                                                        <dx:GridViewDataComboBoxColumn FieldName="CurrencyCode" VisibleIndex="6" Caption="Loại tiền" Width="60" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                            <CellStyle Wrap="True"></CellStyle>
                                                            <PropertiesComboBox>
                                                                <Items>
                                                                    <dx:ListEditItem Value="VND" Text="VND" />
                                                        ...
                                                        <dx:GridViewDataColumn FieldName="Remark" VisibleIndex="8" Caption="Diễn giải" Width="500" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                            <CellStyle Wrap="True"></CellStyle>
                                                        </dx:GridViewDataColumn>
                                                    </Columns>
                                                    <Styles>
                                    ...
                                    <dx:SplitterPane Name="CarrierPane" Size="550">
                                        <ContentCollection>
                                            <dx:SplitterContentControl>
                                                <dx:ASPxGridView ID="CarrierGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                                                    ClientInstanceName="ClientCarrierGrid" Width="100%" KeyFieldName="CarrierCounterID"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataColumn FieldName="Description" VisibleIndex="5" Caption="Diễn giải" Width="450" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                            <CellStyle Wrap="True"></CellStyle>
                                                        </dx:GridViewDataColumn>
                                                    </Columns>
                                                    <Styles>
                                    ...
                                    <dx:SplitterContentControl>
                                        ...
                                        <dx:ASPxGridView ID="UnitPriceGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataComboBoxColumn FieldName="VersionID" VisibleIndex="1" Caption="Version sản lượng" Width="250" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                    <%-- <CellStyle Wrap="True"></CellStyle>--%>
                                                </dx:GridViewDataComboBoxColumn>
                                                ...
                                                <dx:GridViewDataColumn FieldName="Carrier" VisibleIndex="3" Caption="Hãng" Width="60" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                    <CellStyle Wrap="True"></CellStyle>
                                                </dx:GridViewDataColumn>
                                                <dx:GridViewDataColumn FieldName="Network" VisibleIndex="4" Caption="Mạng bay" Width="85" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                    <CellStyle Wrap="True"></CellStyle>
                                                </dx:GridViewDataColumn>
                                                <dx:GridViewDataColumn FieldName="Aircraft" VisibleIndex="5" Caption="Loại tàu" Width="80" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                    <CellStyle Wrap="True"></CellStyle>
                                                </dx:GridViewDataColumn>
                                                <dx:GridViewDataSpinEditColumn FieldName="Quantity" VisibleIndex="6" Caption="Sản lượng" Width="110" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                    <CellStyle Wrap="True"></CellStyle>
                                                    <FooterCellStyle Font-Bold="true"></FooterCellStyle>
                                                    <PropertiesSpinEdit DisplayFormatString="N2"></PropertiesSpinEdit>
                                                </dx:GridViewDataSpinEditColumn>
                                                <dx:GridViewDataSpinEditColumn FieldName="CountersNbr" VisibleIndex="7" Caption="Số quầy" Width="110" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                    <CellStyle Wrap="True"></CellStyle>
                                                    <FooterCellStyle Font-Bold="true"></FooterCellStyle>
                                                    <PropertiesSpinEdit DisplayFormatString="N2"></PropertiesSpinEdit>
                                                </dx:GridViewDataSpinEditColumn>
                                                <dx:GridViewDataSpinEditColumn FieldName="UnitPrice" VisibleIndex="8" Caption="Đơn giá" Width="150" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                    <CellStyle Wrap="True"></CellStyle>
                                                    <PropertiesSpinEdit DisplayFormatString="N2"></PropertiesSpinEdit>
                                                </dx:GridViewDataSpinEditColumn>
                                                <dx:GridViewDataComboBoxColumn FieldName="CurrencyCode" VisibleIndex="9" Caption="Loại tiền" Width="100" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                    <CellStyle Wrap="True"></CellStyle>
                                                    <PropertiesComboBox>
                                                        <Items>
                                                            <dx:ListEditItem Value="VND" Text="VND" />
                                                ...
                                                <dx:GridViewDataColumn FieldName="Description" VisibleIndex="10" Caption="Diễn giải" Width="500" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                    <CellStyle Wrap="True"></CellStyle>
                                                </dx:GridViewDataColumn>
                                            </Columns>
                                            <Styles>
    ...
    <dx:ASPxPopupControl ID="CalcUnitPricePopup" runat="server" ClientInstanceName="ClientCalcUnitPricePopup" Width="500px" Height="150px"
        HeaderText="Tham số phân bổ đơn giá quầy theo tháng cho chuyến bay" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ShowFooter="true">
        <HeaderStyle Font-Bold="True" Font-Size="Medium">
            <Paddings PaddingBottom="5px" PaddingTop="5px" />
        </HeaderStyle>
        <ContentCollection>
                        ...
                        <dx:LayoutItem Caption="Version sản lượng" ColSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="cboCalcUnitPriceVersion" runat="server" ClientInstanceName="ClientCalcUnitPriceVersion" Width="100%" AutoResizeWithContainer="true" ValueType="System.Int32"
