                    ...
                    <dx:SplitterContentControl>
                        <dx:ASPxGridView ID="VersionGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="VersionQuantityName" VisibleIndex="4" Caption="Version" FixedStyle="Left" Width="100" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                </dx:GridViewDataTextColumn>
            ...
            <dx:SplitterPane Size="45" Separator-Visible="False">
                <ContentCollection>
                    <dx:SplitterContentControl>
                        ...
                        <dx:ASPxButton ID="btnApplyToDepartment" runat="server" Text="Apply Version" ClientInstanceName="ClientApplyToDepartment" RenderMode="Button" AutoPostBack="false" Image-Width="18" Image-Url="~/Content/images/if_gtk-execute_23314.png">
                            <ClientSideEvents Click="RevCost.ClientApplyToDepartment_Click" />
                        </dx:ASPxButton>
                        <%-- <dx:ASPxButton ID="btnSynchronizeFASTData" runat="server" Text="Synchronize FAST Data" ClientInstanceName="ClientSynchronizeFASTData" RenderMode="Button" AutoPostBack="false" Image-Width="18" Image-Url="~/Content/images/if_gtk-execute_23314.png">
                            <ClientSideEvents Click="RevCost.ClientSynchronizeFASTData_Click" />
                        </dx:ASPxButton>--%>
                    </dx:SplitterContentControl>
                </ContentCollection>
            </dx:SplitterPane>
                        ...
                        <dx:LayoutItem Caption="Year" ColSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxSpinEdit runat="server" ID="YearEditor" Width="100" ClientInstanceName="ClientYearEditor">
