<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="RevenueCostForDivision.aspx.cs" Inherits="Business_KTQT_RevenueCostForDivision" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <link href="../../Content/RevCost.css" rel="stylesheet" />
    <script src="../../Scripts/jquery-1.11.1.min.js"></script>
    <script src="../../Scripts/PageModuleBase.js"></script>
    <script src="../../Scripts/KTQTRevCostForDivision.js"></script>
                ...
                <ContentCollection>
                    <dx:SplitterContentControl>
                        <div class="powered-text">
                            <asp:Literal ID="Literal1" runat="server" Text="Revenue Cost for Division" />
                        </div>
                    </dx:SplitterContentControl>
                </ContentCollection>
                <PaneStyle>
