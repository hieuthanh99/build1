...
public partial class Business_KTQT_BCN_02 : BasePage
{
    ...
    private void LoadData()
    {
        ...
        List<int> lstSub = entities.BCN_Report_Items.Where(x=>x.ItemGroup =="BM02").Select(x=>x.ItemID).ToList();
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        LoadData();
        GridViewExporter.FileName = "BCN_02.xlsx";
    ...
    protected void btnCreate_Click(object sender, EventArgs e)
    {
        int month = Convert.ToInt32(QueryMonthEditor.Number);
        int year = Convert.ToInt32(QueryYearEditor.Number);
        entities.Gen_BCN_02(year, month);
        LoadData();
    }
}