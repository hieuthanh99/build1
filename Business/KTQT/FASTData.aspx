<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FASTData.aspx.cs" Inherits="Business_KTQT_FASTData" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <link href="../../Content/RevCost.css" rel="stylesheet" />
    <script src="../../Scripts/jquery-1.11.1.min.js"></script>
    <script src="../../Scripts/PageModuleBase.js"></script>
    <script src="../../Scripts/KTQTFASTData.js"></script>
            ...
            <dx:SplitterPane Size="50" Separator-Visible="False">
                <ContentCollection>
                    <dx:SplitterContentControl>
                        <div class="title">
                            <asp:Literal ID="Literal1" runat="server" Text="(FAST) GL Budget theo ngày chứng từ" />
                        </div>
                    </dx:SplitterContentControl>
                </ContentCollection>
                <PaneStyle>
                                ...
                                <ContentCollection>
                                    <dx:SplitterContentControl>
                                        <dx:ASPxGridView ID="DataGrid" runat="server" AutoGenerateColumns="false" EnableCallBacks="true"
                                            ClientInstanceName="ClientDataGrid" Width="100%" KeyFieldName="FASTDataID"
                                            ...
                                            <Columns>
                                             ...
                                             <%--   <dx:GridViewDataTextColumn FieldName="mcp" VisibleIndex="4" Caption="Tháng CP" Width="60" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                ...
                                                <dx:GridViewDataSpinEditColumn FieldName="PS_Trong_Ky" VisibleIndex="8" Caption="PS trong kỳ" Width="170" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                ...
                                                <dx:GridViewDataSpinEditColumn FieldName="Total_PS_TK" VisibleIndex="11" Caption="Tổng PS trong kỳ" Width="170" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                    <PropertiesSpinEdit DisplayFormatString="N2"></PropertiesSpinEdit>
                                                    <FooterCellStyle Font-Bold="true"></FooterCellStyle>
                                                </dx:GridViewDataSpinEditColumn>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="chi_tieu" VisibleIndex="14" Caption="Chỉ tiêu" Width="300" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                </dx:GridViewDataTextColumn>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="tk" VisibleIndex="17" Caption="Tài khoản" Width="200" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                </dx:GridViewDataTextColumn>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="vu_viec" VisibleIndex="19" Caption="Vụ việc" Width="150" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" HeaderStyle-Wrap="True">
                                                </dx:GridViewDataTextColumn>
