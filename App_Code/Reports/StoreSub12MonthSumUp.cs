...
/// <summary>
/// Summary description for StoreSub12MonthSumUp
/// </summary>
public class StoreSub12MonthSumUp : DevExpress.XtraReports.UI.XtraReport
{
    ...
    protected override void OnBeforePrint(System.Drawing.Printing.PrintEventArgs e)
    {
        ...
        decimal outPVERSIONID;
        decimal.TryParse(this.PVERSIONID.Value.ToString(), out outPVERSIONID);

        var VerRec = entities.Versions.Where(x => x.VersionID == outPVERSIONID).SingleOrDefault();

        if (VerRec != null)
        {
            this.xrLabel4.Text = this.xrLabel4.Text + " " + VerRec.VersionYear;
            this.xrLabel15.Text = VerRec.Description;
        }

        this.xrLabel3.Text = "Từ tháng " + this.PFROMMONTH.Value.ToString() + " đến tháng " + this.PTOMONTH.Value.ToString();
        ...
        this.xrTableCell15.FormattingRules.Add(rule);
        this.xrTableCell16.FormattingRules.Add(rule);
        this.xrTableCell17.FormattingRules.Add(rule);
        this.xrTableCell18.FormattingRules.Add(rule);
        this.xrTableCell19.FormattingRules.Add(rule);
        this.xrTableCell20.FormattingRules.Add(rule);
        this.xrTableCell21.FormattingRules.Add(rule);
        this.xrTableCell22.FormattingRules.Add(rule);
        this.xrTableCell23.FormattingRules.Add(rule);
        this.xrTableCell24.FormattingRules.Add(rule);
        this.xrTableCell25.FormattingRules.Add(rule);
        this.xrTableCell26.FormattingRules.Add(rule);
        this.xrTableCell27.FormattingRules.Add(rule);
        this.xrTableCell28.FormattingRules.Add(rule);
        this.xrTableCell29.FormattingRules.Add(rule);
        this.xrTableCell31.FormattingRules.Add(rule);

        //this.xrTableCell15.FormattingRules.Add(rule);

        //this.xrTableCell15.Font = new Font("Times New Roman", 15, FontStyle.Bold);
    ...
    /*
    private void StoreSub12MonthSumUp_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
    {
        QLKHDataEntities entities = new QLKHDataEntities();
        decimal outPVersionId = 0;
        decimal.TryParse(this.PVERSIONID.ToString(), out outPVersionId);

        var verYear = entities.Versions.Where(x => x.VersionID == outPVersionId).SingleOrDefault();

        this.xrLabel4.Text = this.xrLabel4.Text + verYear;
    ...
    */
	...
	private void InitializeComponent() {
            string resourceFileName = "StoreSub12MonthSumUp.resx";
            System.Resources.ResourceManager resources = global::Resources.StoreSub12MonthSumUp.ResourceManager;
            ...
            customSqlQuery1.Name = "Version";
            customSqlQuery1.Sql = "select VersionId, Description + \' -- \' + VersionName NOIDUNG from VERSION\r\nWHERE " +
    "ISNULL(ACTIVE, 0) = 1\r\nORDER BY VERSIONID\r\n";
            storedProcQuery1.Name = "TmpStoreSub12MonthSumUp";
            queryParameter1.Name = "@PVersionId";
            queryParameter1.Type = typeof(DevExpress.DataAccess.Expression);
            queryParameter1.Value = new DevExpress.DataAccess.Expression("[Parameters.PVERSIONID]", typeof(int));
            ...
            storedProcQuery1.StoredProcName = "TmpStoreSub12MonthSumUp";
            this.sqlDataSource1.Queries.AddRange(new DevExpress.DataAccess.Sql.SqlQuery[] {
            customSqlQuery1,
            storedProcQuery1});
            this.sqlDataSource1.ResultSchemaSerializable = "PERhdGFTZXQgTmFtZT0ic3FsRGF0YVNvdXJjZTEiPjxWaWV3IE5hbWU9IlZlcnNpb24iPjxGaWVsZCBOY" +
    "W1lPSJWZXJzaW9uSWQiIFR5cGU9IkRlY2ltYWwiIC8+PEZpZWxkIE5hbWU9Ik5PSURVTkciIFR5cGU9I" +
    "lN0cmluZyIgLz48L1ZpZXc+PC9EYXRhU2V0Pg==";
            ...
            this.xrTableRow2});
            this.xrTable2.SizeF = new System.Drawing.SizeF(1131.928F, 25F);
            ...
            this.xrTableCell15.Weight = 0.0574198857427682D;
            // 
            // xrTableCell16
            // 
            ...
            this.xrTableCell16.Weight = 0.20005533957005031D;
            // 
            // xrTableCell29
            // 
            ...
            this.xrTableCell29.Weight = 0.054902355735449035D;
            // 
            // xrTableCell31
            // 
            ...
            this.xrTableCell31.Weight = 0.058526724898004277D;
            // 
            // xrTableCell17
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[M1]")});
            ...
            this.xrTableCell17.Weight = 0.054024669214414067D;
            // 
            // xrTableCell18
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[M2]")});
            ...
            this.xrTableCell18.Weight = 0.054024667118328477D;
            // 
            // xrTableCell19
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[M3]")});
            ...
            this.xrTableCell19.Weight = 0.054024667118328457D;
            // 
            // xrTableCell20
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[M4]")});
            ...
            this.xrTableCell20.Weight = 0.054024667118328464D;
            // 
            // xrTableCell21
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[M5]")});
            ...
            this.xrTableCell21.Weight = 0.054024667118328457D;
            // 
            // xrTableCell22
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[M6]")});
            ...
            this.xrTableCell22.Weight = 0.054024667118328457D;
            // 
            // xrTableCell23
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[M7]")});
            ...
            this.xrTableCell23.Weight = 0.054024667118328429D;
            // 
            // xrTableCell24
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[M8]")});
            ...
            this.xrTableCell24.Weight = 0.054024667118328484D;
            // 
            // xrTableCell25
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[M9]")});
            ...
            this.xrTableCell25.Weight = 0.054024667118328484D;
            // 
            // xrTableCell26
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[M10]")});
            ...
            this.xrTableCell26.Weight = 0.054024667997746439D;
            // 
            // xrTableCell27
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[M11]")});
            ...
            this.xrTableCell27.Weight = 0.054024668477653359D;
            // 
            // xrTableCell28
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[M12]")});
            ...
            this.xrTableCell28.Weight = 0.054024689408559395D;
            // 
            // TopMargin
            // 
            ...
            this.xrLabel3.LocationFloat = new DevExpress.Utils.PointFloat(6.357829E-05F, 157F);
            this.xrLabel3.Name = "xrLabel3";
            this.xrLabel3.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel3.SizeF = new System.Drawing.SizeF(1149F, 22.99999F);
            ...
            this.xrLabel15.LocationFloat = new DevExpress.Utils.PointFloat(0F, 134F);
            this.xrLabel15.Name = "xrLabel15";
            this.xrLabel15.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel15.SizeF = new System.Drawing.SizeF(1149F, 22.99999F);
            ...
            this.xrLabel5.LocationFloat = new DevExpress.Utils.PointFloat(3.178914E-05F, 111F);
            this.xrLabel5.Name = "xrLabel5";
            this.xrLabel5.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel5.SizeF = new System.Drawing.SizeF(1149F, 22.99999F);
            this.xrLabel5.StylePriority.UseFont = false;
            this.xrLabel5.StylePriority.UseTextAlignment = false;
            this.xrLabel5.Text = "TỔNG HỢP CÔNG TY";
            this.xrLabel5.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            // 
            // xrLabel4
            // 
            this.xrLabel4.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold);
            this.xrLabel4.LocationFloat = new DevExpress.Utils.PointFloat(0F, 88F);
            this.xrLabel4.Name = "xrLabel4";
            this.xrLabel4.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel4.SizeF = new System.Drawing.SizeF(1149F, 23F);
            this.xrLabel4.StylePriority.UseFont = false;
            this.xrLabel4.StylePriority.UseTextAlignment = false;
            this.xrLabel4.Text = "KẾ HOẠCH SẢN XUẤT KINH DOANH PHÂN KỲ NĂM";
            this.xrLabel4.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            // 
            // xrLabel1
            // 
            this.xrLabel1.LocationFloat = new DevExpress.Utils.PointFloat(6.357829E-05F, 65F);
            this.xrLabel1.Name = "xrLabel1";
            this.xrLabel1.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel1.SizeF = new System.Drawing.SizeF(346.9277F, 23F);
            ...
            this.groupHeaderBand1.HeightF = 61.00003F;
            ...
            this.xrLabel14.LocationFloat = new DevExpress.Utils.PointFloat(285.953F, 0F);
            this.xrLabel14.Name = "xrLabel14";
            this.xrLabel14.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel14.SizeF = new System.Drawing.SizeF(60.97476F, 61.00003F);
            this.xrLabel14.StylePriority.UseBorders = false;
            this.xrLabel14.StylePriority.UseFont = false;
            this.xrLabel14.StylePriority.UseTextAlignment = false;
            this.xrLabel14.Text = "ĐƠN VỊ TÍNH";
            ...
            this.xrLabel13.LocationFloat = new DevExpress.Utils.PointFloat(346.9277F, 0F);
            this.xrLabel13.Name = "xrLabel13";
            this.xrLabel13.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel13.SizeF = new System.Drawing.SizeF(65.00003F, 61.00003F);
            this.xrLabel13.StylePriority.UseBorders = false;
            this.xrLabel13.StylePriority.UseFont = false;
            this.xrLabel13.StylePriority.UseTextAlignment = false;
            this.xrLabel13.Text = "CỘNG CÔNG TY";
            ...
            this.xrLabel12.LocationFloat = new DevExpress.Utils.PointFloat(63.77074F, 0F);
            this.xrLabel12.Name = "xrLabel12";
            this.xrLabel12.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel12.SizeF = new System.Drawing.SizeF(222.1822F, 61.00003F);
            this.xrLabel12.StylePriority.UseBorders = false;
            this.xrLabel12.StylePriority.UseFont = false;
            this.xrLabel12.StylePriority.UseTextAlignment = false;
            this.xrLabel12.Text = "NỘI DUNG";
            ...
            this.xrLabel11.LocationFloat = new DevExpress.Utils.PointFloat(6.357829E-05F, 0F);
            this.xrLabel11.Name = "xrLabel11";
            this.xrLabel11.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel11.SizeF = new System.Drawing.SizeF(63.77068F, 61.00003F);
            this.xrLabel11.StylePriority.UseBorders = false;
            this.xrLabel11.StylePriority.UseFont = false;
            this.xrLabel11.StylePriority.UseTextAlignment = false;
            this.xrLabel11.Text = "TT";
            ...
            this.xrLabel10.LocationFloat = new DevExpress.Utils.PointFloat(951.9282F, 0F);
            this.xrLabel10.Name = "xrLabel10";
            this.xrLabel10.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel10.SizeF = new System.Drawing.SizeF(180.0001F, 23F);
            this.xrLabel10.StylePriority.UseBorders = false;
            this.xrLabel10.StylePriority.UseFont = false;
            this.xrLabel10.StylePriority.UseTextAlignment = false;
            this.xrLabel10.Text = "Quý 4";
            ...
            this.xrLabel9.LocationFloat = new DevExpress.Utils.PointFloat(771.928F, 0F);
            this.xrLabel9.Name = "xrLabel9";
            this.xrLabel9.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel9.SizeF = new System.Drawing.SizeF(180.0001F, 23F);
            this.xrLabel9.StylePriority.UseBorders = false;
            this.xrLabel9.StylePriority.UseFont = false;
            this.xrLabel9.StylePriority.UseTextAlignment = false;
            this.xrLabel9.Text = "Quý 3";
            ...
            this.xrLabel8.LocationFloat = new DevExpress.Utils.PointFloat(591.9279F, 0F);
            this.xrLabel8.Name = "xrLabel8";
            this.xrLabel8.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel8.SizeF = new System.Drawing.SizeF(180.0001F, 23F);
            this.xrLabel8.StylePriority.UseBorders = false;
            this.xrLabel8.StylePriority.UseFont = false;
            this.xrLabel8.StylePriority.UseTextAlignment = false;
            this.xrLabel8.Text = "Quý 2";
            ...
            this.xrLabel7.LocationFloat = new DevExpress.Utils.PointFloat(411.9278F, 0F);
            this.xrLabel7.Name = "xrLabel7";
            this.xrLabel7.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel7.SizeF = new System.Drawing.SizeF(180.0001F, 23F);
            this.xrLabel7.StylePriority.UseBorders = false;
            this.xrLabel7.StylePriority.UseFont = false;
            this.xrLabel7.StylePriority.UseTextAlignment = false;
            this.xrLabel7.Text = "Quý 1";
            this.xrLabel7.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            // 
            // xrTable1
            // 
            this.xrTable1.LocationFloat = new DevExpress.Utils.PointFloat(411.9278F, 23.00002F);
            this.xrTable1.Name = "xrTable1";
            this.xrTable1.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow1});
            this.xrTable1.SizeF = new System.Drawing.SizeF(719.9999F, 38.00001F);
            // 
            // xrTableRow1
            // 
            ...
            this.xrTableCell3.Text = "Tháng 1";
            this.xrTableCell3.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCell3.Weight = 0.054026723859863977D;
            // 
            // xrTableCell4
            // 
            ...
            this.xrTableCell4.Text = "Tháng 2";
            this.xrTableCell4.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCell4.Weight = 0.054026723356103382D;
            // 
            // xrTableCell5
            // 
            ...
            this.xrTableCell5.Text = "Tháng 3";
            this.xrTableCell5.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCell5.Weight = 0.054026723085740094D;
            // 
            // xrTableCell6
            // 
            ...
            this.xrTableCell6.Text = "Tháng 4";
            this.xrTableCell6.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCell6.Weight = 0.054026726018695813D;
            // 
            // xrTableCell7
            // 
            ...
            this.xrTableCell7.Text = "Tháng 5";
            this.xrTableCell7.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCell7.Weight = 0.054026722823284259D;
            // 
            // xrTableCell8
            // 
            ...
            this.xrTableCell8.Text = "Tháng 6";
            this.xrTableCell8.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCell8.Weight = 0.054026724813871316D;
            // 
            // xrTableCell9
            // 
            ...
            this.xrTableCell9.Text = "Tháng 7";
            this.xrTableCell9.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCell9.Weight = 0.054026725158131242D;
            // 
            // xrTableCell10
            // 
            ...
            this.xrTableCell10.Text = "Tháng 8";
            this.xrTableCell10.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCell10.Weight = 0.054026723096407984D;
            // 
            // xrTableCell11
            // 
            ...
            this.xrTableCell11.Text = "Tháng 9";
            this.xrTableCell11.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCell11.Weight = 0.054026723096424888D;
            // 
            // xrTableCell12
            // 
            ...
            this.xrTableCell12.Weight = 0.054026724360698011D;
            // 
            // xrTableCell13
            // 
            ...
            this.xrTableCell13.Text = "Tháng 11";
            this.xrTableCell13.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCell13.Weight = 0.054026724344393928D;
            // 
            // xrTableCell14
            // 
            ...
            this.xrTableCell14.Text = "Tháng 12";
            this.xrTableCell14.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCell14.Weight = 0.054026711893509695D;
            // 
            // Title
            // 
            ...
            // PVERSIONID
            // 
            this.PVERSIONID.Description = "Version báo cáo";
            ...
            this.PVERSIONID.LookUpSettings = dynamicListLookUpSettings1;
            this.PVERSIONID.Name = "PVERSIONID";
            this.PVERSIONID.Type = typeof(int);
            this.PVERSIONID.ValueInfo = "24";
            this.PVERSIONID.Visible = false;
            // 
            // PFROMMONTH
            // 
            this.PFROMMONTH.Description = "PFROMMONTH";
            ...
            // PTOMONTH
            // 
            this.PTOMONTH.Description = "PTOMONTH";
            this.PTOMONTH.Name = "PTOMONTH";
            this.PTOMONTH.Type = typeof(int);
            this.PTOMONTH.ValueInfo = "1";
            // 
            // xrPictureBox1
            // 
            ...
            this.xrPictureBox1.SizeF = new System.Drawing.SizeF(346.9278F, 65F);
            this.xrPictureBox1.Sizing = DevExpress.XtraPrinting.ImageSizeMode.ZoomImage;
            // 
            // StoreSub12MonthSumUp
            // 
            ...
            this.sqlDataSource1});
            this.DataMember = "TmpStoreSub12MonthSumUp";
            this.DataSource = this.sqlDataSource1;
            this.Landscape = true;
            this.Margins = new System.Drawing.Printing.Margins(10, 10, 4, 3);
            this.PageHeight = 827;
            this.PageWidth = 1169;
