<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="BaocaoHo.aspx.cs" Inherits="Reports_BaocaoHo" %>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxRadioButtonList ID="rdReport" runat="server" ValueType="System.String" ClientInstanceName="ClientReportName">
                                                        <Items>
                                                            <dx:ListEditItem Value="CT" Text="Báo cáo chi tiết" Selected="true" />
                                                            <dx:ListEditItem Value="TH" Text="Báo cáo tổng hợp" />
                                                        </Items>
                                ...
                                <dx:LayoutGroup Caption="Report Parameters">
                                    <Items>
                                        <dx:LayoutItem Caption="Area">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxComboBox ID="cboArea" runat="server" ValueType="System.Int32" Width="150px">
                                                        ...
                                                        <Items>
                                                            <dx:ListEditItem Value="156" Text="KVP" />
                                                            <dx:ListEditItem Value="3" Text="TÂN SƠN NHẤT" />
                                                            <dx:ListEditItem Value="4" Text="ĐÀ NẴNG" />
                                                            <dx:ListEditItem Value="5" Text="NỘI BÀI" />
                                                        </Items>
                                                    </dx:ASPxComboBox>
                                                </dx:LayoutItemNestedControlContainer>
                                            </LayoutItemNestedControlCollection>
