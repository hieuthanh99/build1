<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ChiphiNhienlieuReport.aspx.cs" Inherits="Reports_ChiphiNhienlieuReport" %>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxRadioButtonList ID="rdReport" runat="server" ValueType="System.String" ClientInstanceName="ClientReport">
                                                        <Items>
                                                            <dx:ListEditItem Value="FuelCostDetail" Text="1. Chi phí nhiên liệu TTB bình quân của 1 máy bay theo hãng" Selected="true" />
                                                            <dx:ListEditItem Value="FuelCostTotal" Text="2. Chi phí nhiên liệu TTB bình quân theo hãng" />
                                                        </Items>
